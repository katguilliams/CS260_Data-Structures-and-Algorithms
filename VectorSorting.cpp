...
int partition(vector<Bid>& bids, int begin, int end) {
	...
	while (!done) {
		...
		if (low >= high) {
			...
			//swap the low and the high using built-in vector method
...
void quickSort(vector<Bid>& bids, int begin, int end) {
	...
	//call quickSort using midpoint value (begin to mid)
	quickSort(bids, begin, mid);

	//call quickSort using midpoint value (mid + 1, end)
